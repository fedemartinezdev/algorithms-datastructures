...
def siftDown(heap, currentIdx, endIdx):
    while currentIdx <= endIdx // 2:
        ...
        if leftChild <= endIdx and heap[leftChild] < heap[currentIdx]:
            if rightChild <= endIdx and heap[rightChild] < heap[leftChild]:
                heap[currentIdx], heap[rightChild] = heap[rightChild], heap[currentIdx]
                currentIdx = rightChild
            else:
                heap[currentIdx], heap[leftChild] = heap[leftChild], heap[currentIdx]
                currentIdx = leftChild
        elif rightChild <= endIdx and heap[rightChild] < heap[currentIdx]:
            heap[currentIdx], heap[rightChild] = heap[rightChild], heap[currentIdx]
            currentIdx = rightChild
        else:
            break
